...
while True:
    ...
    frame_correctness = dot(a_x,a_y)+dot(a_z,a_y)+dot(a_x,a_z) + \
                        1 - (dot(a_z,cross(a_x,a_y)) \
                        *dot(a_x,cross(a_y,a_z)) \
                        *dot(a_y,cross(a_z,a_x)));
    ...
    if autopilot:
        ...
        if a_pos.y < 2000 and a_vel.y < 100:
            ...
            if (crash_1==True)&(crash_2==False):
                ...
                if a_vel.y < 0:
                    ...
                    pilot_u1 =.251-a_vel.y/200
                    pilot_u2= .251-a_vel.y/200
        ...
        if a_pos.y > 2000:
            if a_vel.y < 2 and a_vel.y > -2:
                ...
                if a_vel.y < 50:
                    #print "softly"
                    pilot_u1 =-a_vel.y/8000
                    pilot_u2= -a_vel.y/8000
                else:
                    #print "HARD"
                    pilot_u1 =-.3
                    pilot_u2= -.3
